        ...
        <section className="py-24 px-6 bg-secondary/10">
            <div className="container mx-auto">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                    ...
                    >
                        <div>
                            <span className="text-xs font-sans uppercase tracking-[0.2em] text-muted-foreground mb-4 block">
                    ...
                    <motion.div
                        ...
                        className="relative"
                    >
                        <div className="aspect-[4/5] md:aspect-square bg-white rounded-[3rem] overflow-hidden shadow-xl border border-border/50 relative group">
                            {/* Image background */}
                            <img
                                src={scoutPhoto}
                            ...
                            <div className="absolute inset-0 bg-black/40 group-hover:bg-black/50 transition-colors duration-500 flex flex-col justify-center items-center text-center p-8 text-white">
                                <motion.div
                        ...
                        {/* Background Accent */}
                        <div className="absolute -bottom-6 -right-6 w-full h-full bg-secondary/20 -z-10 rounded-[3rem]" />
                    </motion.div>
                </div>
            </div>
        </section>
